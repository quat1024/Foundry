...
public class BlockRefractorySpout extends BlockFoundrySidedMachine {
	...
	private static final AxisAlignedBB[] COLLISION_NORTH = new AxisAlignedBB[] { new AxisAlignedBB(0.125, 0.125, 0, 0.875, 0.875, 0.1875), new AxisAlignedBB(0.3125, 0.4375, 0.1875, 0.6875, 0.6875, 0.4375) };

	private static final AxisAlignedBB[] COLLISION_WEST = new AxisAlignedBB[] { new AxisAlignedBB(0, 0.125, 0.125, 0.1875, 0.875, 0.875), new AxisAlignedBB(0.1875, 0.4375, 0.3125, 0.6875, 0.6875, 0.6875) };

	private static final AxisAlignedBB[] COLLISION_SOUTH = new AxisAlignedBB[] { new AxisAlignedBB(0.3125, 0.4375, 0.5625, 0.6875, 0.6875, 0.8125), new AxisAlignedBB(0.125, 0.125, 0.8125, 0.875, 0.875, 1) };

	private static final AxisAlignedBB[] COLLISION_EAST = new AxisAlignedBB[] { new AxisAlignedBB(0.5625, 0.4375, 0.3125, 0.8125, 0.6875, 0.6875), new AxisAlignedBB(0.6875, 0.125, 0.125, 1, 0.875, 0.875) };
